...
int	task1timer,task2timer,task3timer,task4timer;
...
#if 1 // No comment
		OSTimeDly(100L);
		printf("%d ",num1); fflush(stdout);	// 문자 'a' 출력
#endif // TODO #3
...
#if 1 // No comment
		OSTimeDly(100L);
		printf("%d ",num2); fflush(stdout);	// 문자 'a' 출력
#endif // TODO #3
...
void Task4(void *pdata)
{
	...
	printf("\n-------  Task4 information -------\n");
	printf("task4 id = %d \n",task_data.OSTCBPrio);
	printf("task4 priority = %d \n",task_data.OSTCBPrio);
	printf("task4 status = %d \n",task_data.OSTCBStat);
	printf("----------------------------------\n");
...
#if 1 // No comment
		OSTimeDly(100L);
		printf("= %d \n",num1++ + num2++); fflush(stdout);	// 문자 'a' 출�
#endif // TODO #3
